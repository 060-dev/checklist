...
/// send. Sending logic is not implemented yet; see
...
class PendingQueueItem {
  ...
  factory PendingQueueItem.fromJson(Map<String, dynamic> json) =>
      PendingQueueItem(
        ...
        jsonBody:
            (json['jsonBody'] as Map?)?.cast<String, dynamic>() ?? const {},
        idempotencyKey: (json['idempotencyKey'] as String?) ?? '',
        mediaFilePaths: (json['mediaFilePaths'] is List)
            ? (json['mediaFilePaths'] as List).whereType<String>().toList()
            : const [],
      );
